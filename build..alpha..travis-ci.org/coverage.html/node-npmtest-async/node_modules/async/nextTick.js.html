...
<head>
    <title>Code coverage report for node-npmtest-async/node_modules/async/nextTick.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-async/node_modules/async/nextTick.js</span></h1>
    ...
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-async/node_modules/async/</a> &#187; nextTick.js</div>
</div>
<div class="body">
...
var _defer;
&nbsp;
<span class="missing-if-branch" title="else path not taken" >E</span>if (_setImmediate.hasNextTick) {
    _defer = process.nextTick;
} else <span class="cstat-no" title="statement not covered" >if (_setImmediate.hasSetImmediate) {</span>
<span class="cstat-no" title="statement not covered" >    _defer = setImmediate;</span>
} else {
<span class="cstat-no" title="statement not covered" >    _defer = _setImmediate.fallback;</span>
}
&nbsp;
