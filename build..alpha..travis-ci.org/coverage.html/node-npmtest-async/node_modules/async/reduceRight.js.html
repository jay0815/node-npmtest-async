...
<head>
    <title>Code coverage report for node-npmtest-async/node_modules/async/reduceRight.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-async/node_modules/async/reduceRight.js</span></h1>
    ...
    <tbody>
        ...
        <td>83.33%<br>(10 / 12)</td>
        <td>75%<br>(3 / 4)</td>
        <td>50%<br>(1 / 2)</td>
        <td>81.82%<br>(9 / 11)</td>
    </tbody>
    </table>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-async/node_modules/async/</a> &#187; reduceRight.js</div>
</div>
<div class="body">
...
<span class="cstat-no" title="statement not covered" >  var reversed = (0, _slice2.default)(array).reverse();</span>
<span class="cstat-no" title="statement not covered" >  (0, _reduce2.default)(reversed, memo, iteratee, callback);</span>
}
