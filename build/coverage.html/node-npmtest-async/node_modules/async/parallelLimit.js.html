...
<head>
    <title>Code coverage report for node-npmtest-async/node_modules/async/parallelLimit.js</title>
    <meta charset="utf-8">
<style>
/* jslint-utility2 */
/*csslint
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-async/node_modules/async/parallelLimit.js</span></h1>
    ...
    <tbody>
        ...
        <td>90.91%<br>(10 / 11)</td>
        <td>75%<br>(3 / 4)</td>
        <td>50%<br>(1 / 2)</td>
        <td>90%<br>(9 / 10)</td>
    </tbody>
    </table>
    <div class="path"><a href="../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-async/node_modules/async/</a> &#187; parallelLimit.js</div>
</div>
<div class="body">
 ...
 */
<span class="fstat-no" title="function not covered" >function parallelLimit(tasks, limit, callback) {</span>
<span class="cstat-no" title="statement not covered" >  (0, _parallel2.default)((0, _eachOfLimit2.default)(limit), tasks, callback);</span>
}
